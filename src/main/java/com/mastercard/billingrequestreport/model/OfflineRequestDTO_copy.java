...
public class OfflineRequestDTO_copy {
   ...
   // private enum  reportType {Summary,Detail};
    ...
    public OfflineRequestDTO_copy() {
    }


    public OfflineRequestDTO_copy(@NotNull String feederType, @NotNull String reportType, SearchCriteria searchCriteria, String requestId, String userId, String createdIimestamp, String lastUpdatedTimestamp, String status, String path, String isDeleted) {
